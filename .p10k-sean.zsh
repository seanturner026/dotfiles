# Generated by Powerlevel10k configuration wizard on 2020-01-17 at 09:44 NZDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=032
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local     parens='%75F'   # blue-violet foreground
    else
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      res+="${parens}(${clean}${POWERLEVEL9K_VCS_BRANCH_ICON}"
    ...
    typeset -g my_git_format="$res${parens})"
  }
